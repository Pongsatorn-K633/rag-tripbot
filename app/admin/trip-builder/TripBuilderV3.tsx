      ...
      <div className="max-w-3xl mx-auto">
        ...
        {tab === 'info' && (
          <div className="bg-white border border-zen-black/10 rounded-xl p-4 space-y-3">
            ...
            {/* HOVER lean of this trip's compact card on /discover. It is not
                a resting tilt: a permanently rotated card loses subpixel text
                antialiasing and looks soft, so the card sits straight and
                leans only while the pointer is on it. Per-trip and
            ...
            <div className="pt-3 border-t border-zen-black/10">
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-basel-brick mb-2">
                เอียงตอนชี้ · Hover tilt <span className="text-zen-black/40 normal-case tracking-normal">(การ์ดใน /discover — เอียงเฉพาะตอนเอาเมาส์ชี้)</span>
              </p>
              <div className="flex gap-2">
                {([
                  { v: 'none', label: 'ไม่เอียง · None' },
